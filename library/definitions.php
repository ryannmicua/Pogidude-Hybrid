...
//sets the path to the theme admin directory
define( 'THEME_ADMIN_DIR', THEME_LIB_DIR . '/admin' );
//sets the path to the theme admin directory URI
define( 'THEME_ADMIN_URI', THEME_LIB_URI . '/admin' );

//sets the path to the theme library functions directory
define( 'THEME_FUNCTIONS', THEME_LIB_DIR . '/functions' );
