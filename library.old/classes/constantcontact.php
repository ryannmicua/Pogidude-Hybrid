<?php
    ...
    */
    class CC_Utility {
        ...
        var $login = 'kimchew'; //Username for your account
        var $password = 'milner123'; //Password for your account
        var $apikey = '7d87ae66-d6a1-4aa9-b8f5-5d5e717e3230'; // API Key for your account.
     ...
     */    
	 public	function addSubscriber($contactXML) {
			...
			if ($return) {
				...
				$this->lastError = $emailAddress . ' already exists.'; 
